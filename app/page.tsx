...
const inspectionSystems = [
  {
    ...
    description: "Vision-based quality control systems for surface defects and label integrity.",
    icon: "search",
  },
  {
    title: "Check Weighers",
    description: "Dynamic inline weighing with automatic reject systems for high-speed lines.",
    icon: "scale",
  },
  {
    title: "Metal Detectors",
    description: "Multi-frequency detection technology for ferrous and non-ferrous contaminants.",
    icon: "sensors",
  },
  {
        ...
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex items-end justify-between mb-8">
              <div>
                <span className="text-primary font-bold font-['Montserrat'] text-[10px] tracking-widest uppercase">
                  Division 01
                </span>
                <h2 className="font-['Montserrat'] font-black text-3xl text-[#020062] mt-2">
                  PACKAGING MACHINES
                </h2>
              </div>
        ...
        <section className="py-16 bg-[#020062] text-white">
          <div className="max-w-7xl mx-auto px-8 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-6">
                ...
                href="/contact"
                className="bg-white text-[#020062] px-12 py-4 font-['Montserrat'] font-bold text-sm uppercase tracking-widest hover:bg-slate-100 transition-colors"
              >
                Request Consultation
              </a>
              
                href="/solutions"
                className="border border-white/30 text-white px-12 py-4 font-['Montserrat'] font-bold text-sm uppercase tracking-widest hover:bg-white/10 transition-colors"
              >
                Technical Catalog
              </a>
            </div>
