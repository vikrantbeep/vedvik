        ...
        <section className="relative min-h-[80vh] flex items-center pt-16">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
            <div className="max-w-2xl text-white">
              <div className="inline-block px-3 py-1 bg-primary/20 border border-primary/30 text-primary-fixed text-[10px] font-bold tracking-[0.2em] uppercase mb-6">Precision Engineering</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {packagingMachines.map((machine) => (
                <div key={machine.title} className="group bg-surface-container-lowest border border-surface-container-highest p-6 flex flex-col gap-4 hover:shadow-lg transition-all">
                  ...
                  <div className="mt-auto pt-4 flex items-center gap-2 text-primary text-[10px] font-black uppercase tracking-tighter">Specifications <span className="material-symbols-outlined text-sm">arrow_forward</span></div>
                </div>
              ))}
            </div>
          </div>
              ...
              {inspectionSystems.map((system) => (
                <div key={system.title} className="group bg-surface-container-lowest border border-surface-container-highest p-6 flex flex-col gap-4 hover:shadow-lg transition-all">
                  <div className="w-12 h-12 bg-primary/10 flex items-center justify-center mb-2">
                    <span className="material-symbols-outlined text-2xl text-primary">{system.icon}</span>
                  </div>
                  ...
                  <div className="mt-auto pt-4 flex items-center gap-2 text-primary text-[10px] font-black uppercase tracking-tighter">Details <span className="material-symbols-outlined text-sm">arrow_forward</span></div>
                </div>
              ))}
            </div>
          </div>
