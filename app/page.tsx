  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── Hero ── */}
        <section className="hero-gradient min-h-screen flex flex-col pt-16">
          <div className="max-w-7xl mx-auto px-6 md:px-8 w-full flex-grow flex items-center py-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
              {/* Copy */}
              <div className="lg:col-span-7">
                <div className="hero-in-1 inline-flex items-center gap-2 px-3 py-1 rounded-full border border-slate-200 bg-white/70 text-xs font-medium uppercase tracking-wider text-[#0C4CA2] mb-8">
