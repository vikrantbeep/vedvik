    ...
    <footer style={{ position: "relative", overflow: "hidden", background: BRAND_GRADIENT, color: "#fff" }}>
      <div style={{ position: "relative", zIndex: 1, maxWidth: MAXW, margin: "0 auto", padding: `clamp(3.5rem,7vw,5rem) ${PAD} 2.5rem`, display: "grid", gridTemplateColumns: "minmax(0,1.6fr) repeat(2, minmax(0,1fr))", gap: "clamp(2rem,5vw,4rem)" }} className="footer-grid">
        <div>
          ...
          <p style={{ ...colStyle, lineHeight: 1.7, maxWidth: "24rem" }}>
            Packaging machinery manufacturer in Ahmedabad, India. Advanced packaging and inspection
            systems for FMCG and pharmaceutical lines — backed by local support.
          </p>
          <div style={{ ...colStyle, lineHeight: 1.6, marginTop: "1.2rem" }}>
            9, Siddhi Vinayak Industrial Estate,<br />Bakrol, 382210 - Ahmedabad, Gujarat, India
          </div>
          <a href="mailto:vikrant@vedvikmachinery.com" style={{ display: "inline-block", marginTop: "0.9rem", color: "#fff", fontWeight: 600, fontSize: "0.9rem", textDecoration: "none" }}>
            vikrant@vedvikmachinery.com
          </a>
        </div>
        <div>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.9rem" }}>
            <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" style={socialStyle}>
            ...
            <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" style={socialStyle}>
